...
/*
  ...
  iframepy.querySelector('button[data-command="kernelmenu:restart"]').show()
  iframepy.querySelector('.lm-Widget .p-Widget .jp-Notebook .jp-mod-scrollPastEnd .jp-NotebookPanel-notebook .jp-mod-commandMode').style.top = 0
